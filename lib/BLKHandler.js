...
// 		console.log('server got close nbr: ', counter)
	...
	conn.on('error', function(err){
		console.log('BLKHandler got connection error ')	

	})

	conn.on('data', function(msg, conn){
// 		console.log("BLKHandler::ondata fd: ", fd, " msg: ", msg, " conn.fd ", conn.socket._handle.fd)
// 		console.log("BLKHandler ondata " + util.inspect(msg))
		handlerFunction(msg, conn, ()=>{ 
// 			console.log("CB after handler ") 
		})
		counter++
	})
