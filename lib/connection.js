...
var Parser = require('./NewMessage').Parser
...
function Connection(socket_)
{
	...
	parser.on("msg", (msg) => {
// 		console.log("connection::onparser:: msg", msg , " fd ", fd, socket._handle.fd, this.socket._handle.fd)
...
// 		console.log('connection::ondata [' + data + "]");
