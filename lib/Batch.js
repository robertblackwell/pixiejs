...
// 		var msg = Message.createMessage(port, verb, msgBody)
		...
		tmp_msg.setBody( "["+ kount +"]" + tmp_msg.body)
		logger(Log.DEBUG, util.inspect(tmp_msg));

		stats.startRequest(tmp_msg.toString().length)
		
		req.sendMessage( tmp_msg, ()=>{
